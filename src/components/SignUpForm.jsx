...
const SignUpForm = ({ onSubmit }) => {
    return (
        <View style={{ backgroundColor: 'white', flexDirection: 'column', padding: 20 }}>
            ...
            <FormikTextInput name="passwordConfirmation" placeholder="Password confirmation" secureTextEntry style={{ marginTop: 10, borderRadius: 3, borderWidth: 1, paddingHorizontal: 15, height: 40}} />
